...
export const Todo = (props) => {
  ...
  <div>
    <table cellSpacing={0}>
      <tr>
        <td colSpan={3} className='title'><h1>Todo</h1></td>
      </tr>
      <tr className='input'>
        <td>
        ...
        <td colSpan={2} className='plus'><Button 
        onClick={addTodo}
        >+</Button></td>
      </tr>
...
const TodoItem = (props) => {
  ...
  <td className='checkbox'><Checkbox checked={ props.isCompleted } ></Checkbox></td>
  <td className='garbage'>
    <IconButton aria-label="delete" size="small" onClick={() => props.deleteTodo(props.text)}>
